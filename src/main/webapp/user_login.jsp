...
<body>
    <header>
        <div class="logo_text">
            <img src="./images/bb_logo.png" alt="e_commison-logo" width="10%" heigth="10%"
    ...
    <div class="login-container">
        ...
        <div class="input-container">
            ...
            <input type="tel" placeholder="Mobile Number" name = "phone_number" autofocus required>
        </div>
        <div class="input-container">
        ...
        <p style="text-align: center;">Click here to <a href="<%= request.getContextPath() +  "/create"%>">Register User</a></p>
